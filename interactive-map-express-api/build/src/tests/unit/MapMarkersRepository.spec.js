...
describe('MapMarkersRepository', () => {
    ...
    it("Creates a valid document", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        chai_1.expect(document.mapMarkerMap.toString()).to.equal(mapId.toString());
        chai_1.expect(document.mapMarkerName).to.equal("test");
        chai_1.expect(document.mapMarkerPositionX).to.equal(200);
        chai_1.expect(document.mapMarkerPositionY).to.equal(200);
    }));
    ...
    it("Gets all markers for a specific map", () => __awaiter(void 0, void 0, void 0, function* () {
        const repo = new RepositoryFactory_1.default().getMapMarkersRepository();
        const documents = yield repo.getByUserIdAndMapId(userId.toString(), mapId.toString());
        chai_1.expect(documents).to.be.an("array");
    }));
    it("Gets one by its id", () => __awaiter(void 0, void 0, void 0, function* () {
        // Create an item first
        const repo = new RepositoryFactory_1.default().getMapMarkersRepository();
        const created = yield repo.create(userId.toString(), {
            mapMarkerMap: mapId.toString(),
            mapMarkerName: "test",
            mapMarkerPositionX: 200,
            mapMarkerPositionY: 200,
        ...
        // Get the item
        const document = yield repo.getOneByUserIdAndMapId(userId.toString(), created.mapMarkerMap.toString(), created.mapMarkerId.toString());
        chai_1.expect(document.mapMarkerMap.toString()).to.equal(mapId.toString());
        chai_1.expect(document.mapMarkerName).to.equal("test");
        chai_1.expect(document.mapMarkerPositionX).to.equal(200);
        chai_1.expect(document.mapMarkerPositionY).to.equal(200);
    ...
    it("Update a document with valid data", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // Update
        const updated = yield repo.update(userId.toString(), created.mapMarkerId.toString(), {
            mapMarkerName: "Updated",
        });
        // Expect new name
        chai_1.expect(updated.mapMarkerName).to.equal("Updated");
    }));
    it("Update a document that doesn't exist", () => __awaiter(void 0, void 0, void 0, function* () {
        const repo = new RepositoryFactory_1.default().getMapMarkersRepository();
        yield chai_1.expect(repo.update(userId.toString(), "123456789123456789123456", {
    ...
    it("Delete a document", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        // Update
        const deleted = yield repo.delete(userId.toString(), created.mapMarkerId.toString());
        // Expect to be true
    ...
    it("Throws an error when deleting a document that doesn't exist", () => __awaiter(void 0, void 0, void 0, function* () {
        const repo = new RepositoryFactory_1.default().getMapMarkersRepository();
        yield chai_1.expect(repo.delete(userId.toString(), "123456789123456789123456")).to.eventually.be.rejectedWith(RepositoryNotFoundError_1.default);
    }));
    /**
